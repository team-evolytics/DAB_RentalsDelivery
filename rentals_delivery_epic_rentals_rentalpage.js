...
function revertButtons_mtn(){
    ...
    if ($('#rentals-booking-widget > div > div.rentals_booking_widget__form > div:nth-child(1) > div.rentals_filters__booking_type > div.rentals_filters__radio_group > label:nth-child(2) > h3').children().length === 0){
