...
function changeCellColor_830(){
    ...
    */
    let color_dictionary_qa = {
        'breck4.qa.vailresorts.com' : '#d71920'
        , 'key4.qa.vailresorts.com' : '#10609e'
        , 'cb4.qa.vailresorts.com' : '#a6192e'
        , 'bc4.qa.vailresorts.com' : '#176999'
        , 'vail4.qa.vailresorts.com' : '#006cd1'
        , 'pc4.qa.vailresorts.com' : '#99191a'
        , 'ns4.qa.vailresorts.com' : '#2f5b7b'
        , 'heavenly4.qa.vailresorts.com' : '#971116'
        , 'wb4.qa.vailresorts.com' : '#bf2c37'
    }

    $('.text_container_s').css({'background-color':color_dictionary_qa[website]});
    $('.arrow-up').css({'border-bottom':'8px solid ' + color_dictionary_qa[website]});
}
...
function revertButtons(){
    ...
    if (x_len < 767) {
        ...
        if (path === '/'){
            ...
            $('#rentals-landing-page > div > div > div.rentals_filters__booking_type > div.rentals_filters__radio_group > label:nth-child(1) > h3.visible-xs.c155__mobilecheckbox--v2').remove();
            $('#rentals-landing-page > div > div > div.rentals_filters__booking_type > div.rentals_filters__radio_group > label:nth-child(2) > h3.visible-xs.c155__mobilecheckbox--v1').remove()
        }
